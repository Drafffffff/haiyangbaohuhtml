  ...
  const createHandScrollWatchers = function() {
    ...
    waveElementWatcher.enterViewport(function() {
      anime({
        targets: "#svg_4",
        d:
          "M1046.6,141.8v241.1H-1.4V136.6c0,0,336.4,85,662.9,12.4C661.5,149,828,101.6,1046.6,141.8z",
        easing: "easeOutQuad",
        duration: 6000,
        loop: true,
        direction: "alternate"
  ...
  const floatWatchers = function() {
    ...
    floatElements.forEach((el, pos) => {
      const scrollElemToWatch = pos
        ? floatElements[pos]
        : floatElements[floatElements.length - 1];
      pos = pos ? pos : floatElements.length;
